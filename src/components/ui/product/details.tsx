            ...
            <div className="data w-full max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <h6 className="font-manrope font-light text-2xl leading-9 text-gray-900 pr-5 sm:border-r border-gray-200 mr-5">
                    1,000 IQD
                  </h6>
                </div>
              </div>
              ...
              >
                ...
                <button className="group py-4 px-5 rounded-full bg-indigo-100 text-indigo-600 font-semibold text-lg w-full flex items-center justify-center gap-2 transition-all duration-500 hover:bg-indigo-100">
                  <svg
